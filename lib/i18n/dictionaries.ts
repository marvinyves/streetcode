...
export const dictionaries = {
  en: {
    ...
    calendar: {
      ...
      economicEmpty: "No major economic releases scheduled this week.",
      timeColumn: "Time",
      currencyColumn: "Cur.",
      eventColumn: "Event",
  ...
  sv: {
    ...
    today: {
      ...
      marketUpdates: "Marknadsuppdateringar",
    ...
    calendar: {
      ...
      economicEmpty: "Ingen större makrostatistik denna vecka.",
      timeColumn: "Tid",
      currencyColumn: "Val.",
      eventColumn: "Händelse",
